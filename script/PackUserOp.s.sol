...
contract SendPackUserOp is Script {
    ...
    function run() public {
        ...
        PackedUserOperation memory userOp = generateSignedUserOperation(executeCallData, config.getConfig(), minimalAccountAddress);
    ...
    function generateSignedUserOperation(bytes memory callData, Config.NetworkConfig memory config, address minimalAccount) public view returns (PackedUserOperation memory) {
